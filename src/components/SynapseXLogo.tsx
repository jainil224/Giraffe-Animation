...
export const SynapseXLogo: React.FC<SynapseXLogoProps> = ({ className = "w-5 h-5", fill = "currentColor" }) => {
  ...
  return (
    ...
    >
      <path d={pathData} />
      <path d={pathData} transform="rotate(90)" />
      <path d={pathData} transform="rotate(180)" />
      <path d={pathData} transform="rotate(270)" />
    </svg>
  );
};
